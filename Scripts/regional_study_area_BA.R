...
Khamra_dem_proj        <- projectRaster(from = Khamra_dem, 
...
## Visualization of the hillshade ##############################################
...
## Visualziation of the DEM and hillshade ######################################
...
## Create a raster stack of the DEM and hillshade ##############################
stack_dem_hill_Sat                <- stack(Satagay_dem_crop,hillshade_sat)

## Convert the raster stack to vector points 
...
## Use the function ploty() ####################################################
## DEM Satagay
p_Satagay <- plot_ly(x = stack_dem_hill_data_Sat$X, y = stack_dem_hill_data_Sat$Y, 
                     z = stack_dem_hill_data_Sat$DEM, type = "contour",
